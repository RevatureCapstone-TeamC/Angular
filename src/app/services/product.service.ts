...
export class ProductService {
  ...
  public purchase(products: Product[]): Observable<any> {
    return this.http.patch<any>(environment.baseUrl + this.productUrl, products, { headers: environment.headers, withCredentials: environment.withCredentials })
  }
}
